...
export default function PublicProfilePage({ params }: PublicProfilePageProps) {
  ...
  useEffect(() => {
    ...
    // For MVP, we'll try to load from localStorage if the ID matches
    ...
    const loadProfile = () => {
      try {
        ...
        if (stored) {
          ...
          if (data.profile && data.profile.id === profileId) {
            setProfile(data.profile);
          } else {
            // Profile not found or ID doesn't match
            setProfile(null);
          }
        } else {
          setProfile(null);
        ...
        <div className="text-center max-w-md">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              This link-in-bio page doesn&apos;t exist or may have been removed.
            </p>
            <Link
              href="/"
